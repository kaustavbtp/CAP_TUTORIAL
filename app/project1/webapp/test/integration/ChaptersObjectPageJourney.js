...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Navigate to ChaptersObjectPageObjectPage", function (Given, When, Then) {
            ...
            Then.onTheBooksObjectPage.onTable({ property: "chapters" }).iCheckRows();
            When.onTheBooksObjectPage.onTable({ property: "chapters" }).iPressRow(0);

            Then.onTheChaptersObjectPage.iSeeThisPage();
        });
